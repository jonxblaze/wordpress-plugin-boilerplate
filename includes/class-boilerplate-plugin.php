...
class Boilerplate_Plugin {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( 
			dirname( __FILE__ ) 
		) . 'includes/class-boilerplate-plugin-loader.php';
		...
		require_once plugin_dir_path( 
			dirname( __FILE__ ) 
		) . 'includes/class-boilerplate-plugin-i18n.php';
		...
		require_once plugin_dir_path( 
			dirname( __FILE__ ) 
		) . 'admin/class-boilerplate-plugin-admin.php';
		...
		require_once plugin_dir_path( 
			dirname( __FILE__ ) 
		) . 'public/class-boilerplate-plugin-public.php';
	...
	private function define_admin_hooks() {
		$plugin_admin = new Boilerplate_Plugin_Admin( 
	...
	private function define_public_hooks() {
		$plugin_public = new Boilerplate_Plugin_Public( 
			$this->get_plugin_name(), 
			$this->get_version() 
		);
